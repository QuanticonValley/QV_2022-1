         ...
         {events.map((e)=>{
            ...
            if (selected){
               ...
               return (
                 <>
                   <ConditionalEvent
                     condition={selectedEvent.info != undefined}
                   >
                     <EventWithActivity active={selected}>
                       {selectedEvent ? (
                         <>
                           <DateT>
                             {selectedEvent.d}-{selectedEvent.m}-
                             {selectedEvent.y}
                           </DateT>
                           <Title>{selectedEvent.event}</Title>
                           <Title>{selectedEvent.info}</Title>
                   ...
                   {/* <Event>
                     <ConditionalEvent condition={selectedEvent.info == undefined}>
                      {selectedEvent
                  ? <>
                     <DateT>
                        {selectedEvent.d}-
