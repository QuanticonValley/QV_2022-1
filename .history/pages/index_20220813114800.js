...
//   };
  ...
  return (
    <QV pg="Principal" button={
	//  <div id="buttonDiv">Sign in</div>
     ...
     data-logo_alignment="left">
      ...
      <script src="https://accounts.google.com/gsi/client" async defer></script>
		<div id="g_id_onload"
     data-client_id="231104193562-jr49orvr3rd8sebmp0bmejfus9qpfsgf.apps.googleusercontent.com"
     data-context="signup"
     data-ux_mode="popup"
     data-callback="function handleCredentialResponse(response) {     const token = response.credential;     console.log("Encoded JWT ID token: " + token);     cookie.set("token", token, { expires: 1 });   }"
     data-nonce=""
