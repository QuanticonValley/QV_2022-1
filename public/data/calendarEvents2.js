const events = [
   ...
   { d: 2, m: 11, y: 2022, event: 'Mentoría\nLugar: Salones 2do y 3er piso CyT' },
   { d: 4, m: 11, y: 2022, expires: 'Entregables:\nPrimera entrega página web WIX' },
   { d: 7, m: 11, y: 2022, event: 'Festivo' },
   { d: 9, m: 11, y: 2022, event: 'Pitch de Edificio 2\nLugar: Salones 2do y 3er piso CyT' },
   { d: 10, m: 11, y: 2022, expires: 'Fin zona de inversión\nen asesores Edficio 2' },
   { d: 14, m: 11, y: 2022, event: 'Festivo\nAsignación puntos de\nvictoria Edificio 2' },
   ...
   { d: 22, m: 11, y: 2022, expires: 'Entregables: Trabajo escrito final (también subirlo a página WIX)' },
   { d: 23, m: 11, y: 2022, event: 'Feria: Ingenia Futuro\nLugar: CyT', expires: 'Evaluación pitch final (edificio 3), página web y prototipo' },
